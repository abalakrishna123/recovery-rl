...
do
	...
	python -m rrl_main --env-name navigation2 --cuda --logdir navigation2 --logdir_suffix safety_editor --num_eps 400 --num_unsafe_transitions 20000 --use_safety_editor --safety_editor_lambda 0.5 --seed $i
done
